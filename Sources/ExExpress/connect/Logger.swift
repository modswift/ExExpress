...
private struct LogInfoProvider {
  ...
  var ua           : String? { return req.getHeader("User-Agent") as? String }
  var referrer     : String? { return req.getHeader("Referrer")   as? String }
  ...
  var date  : String {
    ...
    let ftime = time(nil).componentsInLocalTime
    return "\(ftime.format(logdatefmt))"
  }
